...
export default function Home() {
  ...
  const particlesOptions = useMemo( () => ({ preset: "triangles", }), [], );
  ...
  return (
    ...
    <div className={darkMode ? 'dark' : ''}>
      ...
      <main className="pb-10 md:px-20 lg:px-40 dark:bg-gradient-to-b dark:from-white dark:to-teal-500">
        {init && !darkMode && ( <div className="absolute top-0 left-0 w-full h-full -z-10"> <Particles id="tsparticles" options={particlesOptions} /> </div> )}
