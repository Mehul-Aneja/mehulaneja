...
export default function Home() {
  ...
  return (
    ...
    <div className={darkMode ? 'dark' : ''}>
      ...
      <main className="pb-10 md:px-20 lg:px-40 dark:bg-gradient-to-b dark:from-white dark:via-cyan-500 dark:to-cyan-900">
        ...
        <section className="min-h-screen">
          ...
          <div className="text-center pt-12">
            <h2 className="text-6xl text-cyan-500 font-medium dark:text-black">Mehul Aneja</h2> 
            <h3 className="text-2xl pt-5 text-cyan-400 dark:text-slate-900">Contact: mehulaneja123@gmail.com</h3>
            <h3 className="text-2xl pb-10 text-cyan-400 dark:text-slate-900">Bachelors in Computer Science & Mathematics @ New York University 2024</h3>
          </div>
